...
@Autonomous(name = "ARF_1Set", group = "Red Far")
public class AutoRedFar_1Set extends OpMode {
...
//        telemetry.addData("Velocity Error", velocityError);
    ...
    private final Pose pickup1 = new Pose(126, 76.5, Math.toRadians(0)); // Lowest (Third Set) of Artifacts from the Spike Mark.

    private final Pose gotopickup1 = new Pose(100, 76.5, Math.toRadians(0));
        ...
        switch (pathState) {
            ...
            case 1:
                if (opmodeTimer.getElapsedTimeSeconds() >= 1) {
                    ...
                    robot.spin.setTargetPosition(-150);
