...
@Autonomous(name = "ARF_2Set", group = "Red Far")
public class AutoRedFar_2Set extends OpMode {
...
//        telemetry.addData("Velocity Error", velocityError);
    ...
    private final Pose startPose = new Pose(95.5, 8.88, Math.toRadians(90)); // Start Pose of our robot. 68.5  6.5
    private final Pose score = new Pose(95.5, 16, Math.toRadians(90)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
    //    private final Pose move = new Pose(111.5, 98.5, Math.toRadians(38)); // Highest (First Set) of Artifacts from the Spike Mark.

    private final Pose score2 = new Pose(97.5, 18, Math.toRadians(89));

    private final Pose park = new Pose(95.5, 30, Math.toRadians(90)); // Middle (Second Set) of Artifacts from the Spike Mark.
    private final Pose pickup1 = new Pose(143, 38, Math.toRadians(0)); // Lowest (Third Set) of Artifacts from the Spike Mark.

    private final Pose gotopickup1 = new Pose(95.5, 38, Math.toRadians(0));
