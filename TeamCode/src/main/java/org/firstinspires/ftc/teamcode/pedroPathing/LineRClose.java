...
@Autonomous(name = "LineRClose", group = "Red Line")
public class LineRClose extends OpMode {
    ...
    private final Pose score = new Pose(94, 106, Math.toRadians(38)); // 100.5 Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
    //    private final Pose move = new Pose(111.5, 98.5, Math.toRadians(38)); // Highest (First Set) of Artifacts from the Spike Mark.
    private final Pose line = new Pose(86, 108, Math.toRadians(38));; // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
