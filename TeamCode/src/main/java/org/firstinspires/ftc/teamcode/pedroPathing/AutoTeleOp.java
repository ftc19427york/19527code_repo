...
public class AutoTeleOp extends OpMode {
    ...
    private final Pose redGoal = new Pose(133,133, Math.toRadians(0)); //lastest #s 140/135 138 133.5 0  142 125 38 test #s
...
/** SPOON (LIFT) **/
        if (gamepad2.right_bumper && velocityError <= tolerance) {
            ...
            gamepad2.rumble(200); // Only rumble if they tried to shoot while not ready
        }
