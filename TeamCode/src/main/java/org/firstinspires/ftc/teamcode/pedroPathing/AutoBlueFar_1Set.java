...
@Autonomous(name = "ABF_1Set", group = "Blue Far")
public class AutoBlueFar_1Set extends OpMode {
...
//    double targetPower = 0;
    ...
    double tolerance = 50;
    private final Pose blueGoal = new Pose(28,126, Math.toRadians(0)); //138 133.5 0  142 125 38 test #s134.5/126
