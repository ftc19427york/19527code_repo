...
@Autonomous(name = "LineBFar", group = "Blue Line")
public class LineBFar extends OpMode {
...
robot.lift.setPosition(0.05);
    ...
    private final Pose startPose = new Pose(40.09, 8.88, Math.toRadians(90)); // Start Pose of our robot. 68.5  6.5
    private final Pose line = new Pose(34.30, 8.88, Math.toRadians(90)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
