...
@Autonomous(name = "Blue Close GATE", group = "Blue Close")
public class AutoBlueClose_GATE extends OpMode {
    ...
    private final Pose startPose = new Pose(21, 121.70, Math.toRadians(141.25)); //(x:22.5   Y:120   H: 140 )
    private final Pose score = new Pose(47.78, 106, Math.toRadians(141.25));//(x:48   Y:102   H: 140 ) /

    private final Pose park = new Pose(55, 108, Math.toRadians(142)); //(x:23.5   Y:95   H: 0 )
    private final Pose pickup1 = new Pose(13, 82.5, Math.toRadians(180)); // Lowest (Third Set) of Artifacts from the Spike Mark.

    private final Pose gotopickup1 = new Pose(41, 82.5, Math.toRadians(180));

    private final Pose pickup2 = new Pose(4, 57.5, Math.toRadians(180)); // Lowest (Third Set) of Artifacts from the Spike Mark.

    private final Pose gotopickup2 = new Pose(41, 57.5, Math.toRadians(180));

    private final Pose gohitgate = new Pose(23, 72, Math.toRadians(180));

    private final Pose goscore1 = new Pose(31, 72, Math.toRadians(180));

    private final Pose hitgate = new Pose(15.5, 72, Math.toRadians(180));
