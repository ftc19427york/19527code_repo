...
@Autonomous(name = "AutoTest_Daz", group = "A")
public class AutoTest_Daz extends OpMode {
    ...
    private final Pose score = new Pose(100.5, 93.5, Math.toRadians(38)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
    ...
    private final Pose pickup1 = new Pose(129, 77, Math.toRadians(0)); // 76.5Lowest (Third Set) of Artifacts from the Spike Mark.

    private final Pose gotopickup1 = new Pose(100, 77, Math.toRadians(0));

    private final Pose pickupGate = new Pose(145.72, 55.58, Math.toRadians(35.33));


    private final Pose gohitgate = new Pose(118, 70, Math.toRadians(0));

    private final Pose goscore1 = new Pose(110, 70, Math.toRadians(0));

    private final Pose hitgate = new Pose(129, 70, Math.toRadians(0));


//    private final Pose pickup2 = new Pose(140, 52, Math.toRadians(0)); // 59.5Lowest (Third Set) of Artifacts from the Spike Mark.
//
//    private final Pose gotopickup2 = new Pose(100, 52, Math.toRadians(0));
    ...
    private PathChain backup, scorePickup1, goscorePickup1, grabgate, goscorePickup2, gate, gotogate, end, gograbPickup1, grabPickup1, gograbPickup2, grabPickup2;
...
//
//        scorePickup1 = follower.pathBuilder()
//                .addPath(new BezierCurve(score, goscorePickup1, pickupGate))
//                .setLinearHeadingInterpolation(score.getHeading(), score.getHeading())
//                .build();
